...
#' @param group group=TRUE/FALSE. Default is FALSE Where group=FALSE, intake rail will be generated for entire dataset. Where group=TRUE, intake rail will be generated for each group.
